...
namespace librealsense
{
    namespace platform
    {
        ...
        {
            CoInitializeEx(nullptr, COINIT_APARTMENTTHREADED); // when using COINIT_APARTMENTTHREADED, calling _pISensor->SetEventSink(NULL) to stop sensor can take several seconds
